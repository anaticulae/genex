...
* add rebase step (57b060f82ca1)
* upgrade requirements.txt (9aae193c0fe1)
* upgrade Jenkinsfile (cad01a694cf0)
* upgrade pipe library (6b01bdf9f27f)
...
* upgrade requirements.txt (4145d03d8dbb)
